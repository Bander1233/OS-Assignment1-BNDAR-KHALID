...
class Process implements Runnable {
    ...
    public Process(String name, int burstTime, int timeQuantum, int priority) {
        ...
        this.priority = priority; // Feature 1: Set priority
    ...
    // feature 3: Get total waiting time of the process
    public long getWaitingTime() {
        return waitingTime;
        // Feature 3: Add waiting time to the process
    ...
    // Feature 3: Get arrival time
    public long getArrivalTime() {
        return arrivalTime;
    }

    // Feature 3: Update arrival time
...
public class SchedulerSimulation {
    ...
    public static int contextSwitches = 0; // Feature 2: Static counter for context switches

    public static void main(String[] args) {
        // ⚠️ IMPORTANT: Put your student ID here to seed the random number generator
        // This makes your output unique to you - DO NOT forget to change this!
        int studentID = 445050215; // ← CHANGE THIS TO YOUR ACTUAL STUDENT ID
        ...
        for (int i = 1; i <= numProcesses; i++) {
            ...
            // time quantum
            // Feature 1: Passed priority to Process constructor
        ...
        while (!processQueue.isEmpty()) {
            ...
            contextSwitches++; // Feature 2: Increment the counter each time a new process starts running
            ...
            // Feature 3: Record the time when the process starts execution
            ...
            // Feature 3: Record the time when execution finishes
            ...
            // Feature 3: Update arrival time for the next round
    ...
    public static void addProcessToQueue(Process process, Queue<Thread> processQueue,
        ...
        // Feature 1: Display priority when a process enters the ready queue
